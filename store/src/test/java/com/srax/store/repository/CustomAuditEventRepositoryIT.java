package com.srax.store.repository;

import com.srax.store.StoreApp;

import com.srax.store.config.Constants;
import com.srax.store.config.audit.AuditEventConverter;
import com.srax.store.domain.PersistentAuditEvent;
...
import static com.srax.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
