...
export class InvoiceDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('storeApp.invoice.delete.question'));
...
export default class InvoiceComponentsPage {
  ...
  async deleteInvoice() {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/storeApp.invoice.delete.question/);
