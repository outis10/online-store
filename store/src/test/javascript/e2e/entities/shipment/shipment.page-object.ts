...
export class ShipmentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('storeApp.shipment.delete.question'));
...
export default class ShipmentComponentsPage {
  ...
  async deleteShipment() {
    ...
    expect(await shipmentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/storeApp.shipment.delete.question/);
